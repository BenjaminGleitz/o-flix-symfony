...
class TvShowController extends AbstractController
{
     ...
     * @return void
     */
    public function delete($id,  TvShowRepository $tvShowRepository) {
        
        // On recupere la série à supprimer
        $tvShowToDelete = $tvShowRepository->find($id);
        ...
        $em = $this->getDoctrine()->getManager();
        $em->remove($tvShowToDelete);
        $em->flush();

        return $this->json([
            'message' => 'La série ' . $id . ' à bien été supprimer'
        ]);
    }
}
